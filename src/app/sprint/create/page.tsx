...
export default function CreateSprintPage() {
  const { clientes, addSprint, setSprintAtiva } = useScrum();
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Criar nova sprint
    const sprint = addSprint({ clienteId: selectedCliente.id, name, startDate, endDate, totalTasks: 0, isActive: ativarSprint });
